...
export default function ResultScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (Number(enteredFuelAmount) <= Number(availableFuelCapacity)) {
      ...
      try {
        const response = await axios.post(
          `https://17cb-2402-4000-13e3-9df0-bd8b-d170-390e-b908.ngrok-free.app/api/fuelAllocation/add/${vehicleId}/${userId}`,
          data,
          {
            headers: {
        ...
        await axios.post(
          `https://17cb-2402-4000-13e3-9df0-bd8b-d170-390e-b908.ngrok-free.app/api/${vehicleId}/update-fuel`,
          enteredFuelAmount,
          {
            headers: {
              "Content-Type": "application/json",
        ...
        const response4 = await axios.get(
          `https://17cb-2402-4000-13e3-9df0-bd8b-d170-390e-b908.ngrok-free.app/api/findfuel/${fuelType}`
        );
      ...
      try {
        ...
        await axios.post(
          `https://17cb-2402-4000-13e3-9df0-bd8b-d170-390e-b908.ngrok-free.app/api/fuel/updatefuel/${stLicense}`,
          body
        ),
          {
            headers: {
    ...
    try {
      ...
      const response = await axios.post(
        "https://17cb-2402-4000-13e3-9df0-bd8b-d170-390e-b908.ngrok-free.app/api/notifications/generateNotifications",
        {},
        {
          params: {
            telno: "+94743159018", 
    ...
    const fetchMobileNumber = async () => {
      try {
        const response = await axios.get(
          `https://17cb-2402-4000-13e3-9df0-bd8b-d170-390e-b908.ngrok-free.app/api/account/${userId}`
        );
